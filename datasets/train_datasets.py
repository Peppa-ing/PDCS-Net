...
class Train_Dataset(Dataset):
    def __init__(self, args, index=''):
        self.args = args
        self.file_path_list = self.get_file_path(os.path.join(args.root_path, 'train_path_list.txt'), index)
        # 预处理
    ...
    def get_file_path(self, file_path, index):  # D:\MyCodes\pytorch\Dual_UNet_plaque_segmentation\train_path_list.txt
        file_path_list = []
